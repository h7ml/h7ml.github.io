import{_ as n,o as s,c as a,f as e}from"./app-Q-AMctCt.js";const t={},p=e(`<h1 id="javascript-获取节点-操作节点" tabindex="-1"><a class="header-anchor" href="#javascript-获取节点-操作节点" aria-hidden="true">#</a> JavaScript 获取节点，操作节点</h1><h2 id="获取节点" tabindex="-1"><a class="header-anchor" href="#获取节点" aria-hidden="true">#</a> 获取节点</h2><p>父节点.childNodes 获取子节点（包含一切节点）</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code>p<span class="token punctuation">.</span>nodeType <span class="token operator">==</span> <span class="token number">1</span><span class="token comment">// true 判断是否存在节点 是不是一个元素</span>
